...
function renderAppSidebarLayout(initialPathname: string) {
...
describe("AppSidebarLayout auto-collapse", () => {
  ...
  it("auto-collapses when the chat panel appears after a thread route layout mounted", async () => {
    mounted = await renderAppSidebarLayout("/environment-local/thread-123");
  ...
  it("does not install delayed auto-collapse behavior on the index route", async () => {
