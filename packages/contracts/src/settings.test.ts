...
describe("ClientSettings.defaultThreadRuntimeMode", () => {
  it("defaults new thread permissions to follow-last", () => {
    expect(DEFAULT_CLIENT_SETTINGS.defaultThreadRuntimeMode).toBe("follow-last");
    expect(decodeClientSettings({}).defaultThreadRuntimeMode).toBe("follow-last");
  });

  it("accepts explicit runtime mode preferences in patches", () => {
    expect(
      decodeClientSettingsPatch({
        defaultThreadRuntimeMode: "codex-auto-review",
      }).defaultThreadRuntimeMode,
